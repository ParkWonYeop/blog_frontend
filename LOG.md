...
- Later the same day: the Online lobby's time-control picker is split into separate 블리츠 (1분·3분) and 래피드 (10분·15|10·30|15) groups instead of one segmented control; `TIME_CONTROLS` carries a `group` field. Checked visually on a local dev server.
