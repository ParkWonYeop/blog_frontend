...
import { deletePost, getPosts } from '@/features/post/api';
import PostDeleteDialog from '@/features/admin/components/posts/PostDeleteDialog';
import WindowSurface from '@/shared/ui/WindowSurface';
import { flattenCategoryOptions } from '@/features/category/lib';
