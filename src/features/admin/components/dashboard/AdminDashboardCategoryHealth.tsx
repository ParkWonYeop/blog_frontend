...
import type { DashboardCategoryStat } from '@/shared/types';
          ...
          <div className="min-w-[680px]">
            ...
            {categoryStats.slice(0, 6).map((category) => (
              ...
              >
                ...
                <span className="truncate text-[var(--color-text-subtle)]">{formatKoreanReadableDate(category.lastPublishedAt, false, '발행 기록 없음')}</span>
